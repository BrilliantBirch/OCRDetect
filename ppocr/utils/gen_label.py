...
def gen_det_label(root_path, input_dir, out_label):
    with open(out_label, 'w',encoding="utf-8-sig") as out_file:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--root_path',
        type=str,
        default=r"E:\OCRDetect\train_data\icdar2015\rec\train",
        help='The root directory of images.Only takes effect when mode=det ')
    parser.add_argument(
        '--input_path',
        type=str,
        default=r"E:\OCRDetect\train_data\icdar2015\rec\rec_gt_train1.txt",
        help='Input_label or input path to be converted')
    parser.add_argument(
        '--output_label',
        type=str,
        default=r"E:\OCRDetect\train_data\icdar2015\rec\train\rec_gt_train.txt",
